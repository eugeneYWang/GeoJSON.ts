...
var GeoJSON = /** @class */ (function () {
    function GeoJSON() {
        ...
        this.isGeometryValid = function (geometry) {
            if (!geometry || !Object.keys(geometry).length) {
                return false;
            }
        };
    }
    GeoJSON.prototype.InvalidGeometryError = function () {
        var arguments_arr = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            arguments_arr[_i] = arguments[_i];
        }
    ...
    GeoJSON.prototype.parse = function (objects, params, callback) {
        var geojson, settings = this.applyDefaults(params, this.default), propFunc;
        ...
        if (Array.isArray(objects)) {
            ...
            objects.forEach(function (item) {
                geojson.features.push(this.getFeature({ item: item, params: settings, propFunc: propFunc }));
            });
    ...
    GeoJSON.prototype.checkCRS = function (crs) {
        if (crs.type === "name") {
    ...
    GeoJSON.prototype.setGeomAttrList = function (params) {
        for (var param in params) {
    ...
    GeoJSON.prototype.getFeature = function (args) {
    ...
    GeoJSON.prototype.isNested = function (val) {
        return /^.+\..+$/.test(val);
    };
    // Assembles the `geometry` property
    // for the feature output
    GeoJSON.prototype.buildGeom = function (item, params) {
        var geom = {};
        //   attr;
...
var res = geo.parse(data, { Point: ["lat", "lng"] });
var res1 = geo.parse(data, { Point: ["lat", "lng"] });
console.log(res);
console.log(res1);
//# sourceMappingURL=geojsonTS.js.map